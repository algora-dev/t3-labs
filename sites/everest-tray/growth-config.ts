...
/**
 * EVEREST TRAY - Digital Growth Proposal
 * Built from the Everest Tray Digital Growth Proposal PDF (Aug 2026).
 */

export const everestTrayGrowthProposal: GrowthProposalConfig = {
  slug: "everest-tray",
  layout: "growth",
  prospectId: "EVEREST-TRAY",
  companyName: "Everest Tray",
  ...
  hero: {
    ...
    supportingCopy:
      "Create a professional online presence that makes Everest Tray easy to find, understand and trust, while strengthening the wider roofing and cladding business.",
    metaChips: ["Digital foundation", "Product growth", "Less owner workload"],
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        "Rebuild the current website and decide whether Everest Tray is best presented within it or through a dedicated product site",
        ...
        "Create useful pages, FAQs, guides, project content and technical resources that help Google, ChatGPT and customers understand and trust the business",
        "Improve Google Business, reviews, photos, video and other trust signals, and add useful tools such as estimators, quote requests or project information where valuable",
        "Set up measurement so we can see what is being found, what creates enquiries and where to focus next",
      ],
    },
    {
      type: "list",
      ...
      items: [
        ...
        "Improve and expand the pages that are gaining search visibility and enquiries, including new locations and customer questions",
    ...
    {
      type: "groups",
      heading: "What each stage delivers",
      groups: [
        {
          heading: "Stage one gives you",
          items: [
            "A professional digital asset that can begin creating opportunities while its visibility and reputation continue to build over time",
          ],
        },
        {
