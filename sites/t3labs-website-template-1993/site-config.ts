...
const asset = (name: string) => `/proposal-assets/t3labs-website-template-1993/${name}`;

export const t3LabsWebsiteTemplate = {
  slug: "t3labs-website-template-1993",
  companyName: "T3 Labs Website Template",
  seo: {
    title: "T3 Labs Website Template | Roofing and Contractor Website Example",
    description: "A reusable T3 Labs contractor website template based on the Falcon Contracting proposal design.",
  },
  brand: {
    logo: { src: asset("falcon-logo.png"), alt: "T3 Labs website template logo" },
    wordmark: { src: asset("falcon-wordmark.png"), alt: "T3 Labs website template logo" },
  ...
  contactSection: { eyebrow: "Contact", title: "Tell us about your upcoming project.", description: "Share the basics of the job, or call Falcon directly to discuss new roofs, repairs, refurbishment or construction work.", formStatus: "Please call 07921 914875 to continue your enquiry.", generalFormTitle: "Send Falcon a message" },
  quoteRequest: {
    eyebrow: "Quote request form",
    title: "Request a quote",
    helperText: "The more info you can provide us now the faster we can get a quote back to you",
  ...
  requiresConfirmation: ["Template content should be replaced before using it for a real prospect.", "Template images should be replaced with prospect-specific assets before launch.", "Form delivery needs a real provider before the enquiry form can send messages."],
