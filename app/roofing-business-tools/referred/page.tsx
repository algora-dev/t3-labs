...
@media(max-width:720px){.rb-capabilities{grid-template-columns:1fr}.rb-shell{padding-inline:18px}.rb-header-inner{min-height:60px}.rb-brand b,.rb-header-demo{display:none}.rb-header-call{font-size:11px}.rb-hero{padding:54px 0 58px}.rb-hero-grid{gap:35px}.rb-hero h1{font-size:40px}.rb-lead{font-size:16px}.rb-quick-strip .rb-shell,.rb-picker-grid,.rb-custom-grid,.rb-outcome-list{grid-template-columns:1fr}.rb-section{padding-block:66px}.rb-heading h2,.rb-outcomes h2,.rb-close h2{font-size:34px}.rb-heading>p:last-child{font-size:16px}.rb-flow-panel,.rb-tool-card,.rb-user-panel{padding:20px}.rb-step-row{grid-template-columns:1fr}.rb-carousel-image img{height:300px}.rb-carousel figcaption{display:grid}.rb-carousel-controls{justify-self:end}.rb-user-panel{gap:18px}.rb-footer .rb-shell{flex-direction:column}.rb-lightbox{padding:16px}.rb-lightbox-close{right:12px;top:12px}}
`;
