    ...
    <main className="rb-page">
        ...
        <div className="rb-shell rb-hero-grid">
          ...
          <div className="rb-hero-visual">
            <div className="rb-hero-video">
              <iframe
                src="https://www.youtube.com/embed/FIqNbi3bG7A"
      ...
      <section className="rb-section rb-tools-showcase">
        <div className="rb-shell">
          ...
          {orderedModules.length === 0 ? (
            <p className="rb-showcase-empty">Select a tool above to see it in action here with real screenshots from the Apex demo.</p>
          ) : (
