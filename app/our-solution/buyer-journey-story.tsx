    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-5">
        ...
        <div className="mt-10 max-w-3xl">
          ...
          <p className="mt-5 text-5xl font-bold leading-tight tracking-tight">The goal is to be part of <span style={{ color: t.accentInk }}>the answer AI search gives</span>.</p>
        </div>
      </div>
    </section>
  );
