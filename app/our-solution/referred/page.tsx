...
function Assessment({ t }: { t:Tokens }) {
      ...
      <div style={{ background:t.surface, borderColor:t.border }} className="rounded-2xl border p-6 sm:p-8">
        ...
        <div className="mt-7">
          <button
            ...
            className="btn-solid min-h-12 rounded-full px-7 text-sm font-semibold"
          >
            Continue with your representative
          </button>
          <p className="mt-3 text-sm leading-6" style={{ color:t.muted }}>
            The person who shared this page with you can help scope the next step and bring T3 Labs into the conversation when needed.
          </p>
        </div>
      </div>
    );
...
export default function ConstructionSolutionPage(){
  ...
  return (
    <main style={{background:t.bg,color:t.text,["--accent" as string]:t.accent,["--accent-ink" as string]:t.accentInk}} className="min-h-screen antialiased">
      ...
      <div style={{background:t.surfaceAlt,borderColor:t.border}} className="border-b">
        <div className="mx-auto max-w-6xl px-5 py-2.5">
          <p className="text-center text-xs font-medium leading-5 sm:text-sm" style={{color:t.muted}}>
            This page was shared with you by a T3 Labs representative. Please continue the conversation with the person who referred you.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-6xl px-5">
        ...
        <section id="start" className="scroll-mt-20 py-16 sm:py-24">
          <div id="next-step" style={{background:t.surfaceAlt,borderColor:t.border}} className="scroll-mt-24 rounded-3xl border p-6 sm:p-10 lg:p-12">
            ...
            <p className="mt-5 max-w-3xl leading-7" style={{color:t.muted}}>
              They can help you identify the first useful problem to solve, show the most relevant examples, discuss likely scope and pricing, and bring T3 Labs into the conversation when needed.
            </p>
            ...
            <div style={{background:t.surface,borderColor:t.border}} className="mt-7 rounded-2xl border p-6">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {["Pricing or estimating","Product guidance","Online sales assistant","Mobile or website improvements","Reducing manual work","Something bespoke"].map(item=>(
                  <span key={item} style={{background:t.surfaceAlt,borderColor:t.border}} className="rounded-full border px-4 py-2 text-sm font-medium">
                    {item}
                  </span>
                ))}
              </div>
            ...
            <p className="mt-5 text-xs leading-5" style={{color:t.muted}}>
              T3 Labs will support the technical discovery and delivery process. Your referring representative remains your sales point of contact unless agreed otherwise.
            </p>
          </div>
        </section>
      </div>
      ...
      <div className="fixed inset-x-4 bottom-4 z-40 sm:hidden">
        <button
          ...
          onClick={()=>scrollToId("next-step")}
          style={{background:t.accent,color:t.accentText}}
          className="btn-solid flex min-h-12 w-full items-center justify-center rounded-full px-6 text-sm font-semibold shadow-lg"
        >
          Continue with your representative
        </button>
      </div>
