...
const light: Tokens = {
  bg: "#f5f6f8", surface: "#fff", surfaceAlt: "#f0f2f5", border: "#dde2e8",
  text: "#0a0b10", muted: "#5e6674", accent: "#d7ff00", accentText: "#0a0b10",
  accentInk: "#5f7000", accentSoft: "rgba(215,255,0,.18)",
};
...
.btn-outline:hover{transform:translateY(-2px);border-color:var(--accent-ink)!important;box-shadow:0 0 0 1px rgba(215,255,0,.18),0 0 22px rgba(215,255,0,.10)}
`;
