    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5">
          <span className="hidden items-center gap-1.5 rounded-full bg-white/10 px-2.5 py-1 text-[10px] font-semibold text-white/80 lg:flex"><span className="h-1.5 w-1.5 rounded-full bg-emerald-300" />Business data connected</span>
          ...
          <button onClick={handlePin} aria-label={pinned ? 'Unpin assistant' : 'Pin assistant'} title={pinned ? 'Unpin Assistant' : 'Pin Assistant'} className="hidden h-8 w-8 items-center justify-center rounded-full bg-white/10 hover:bg-white/20 lg:flex">
            {pinned ? (
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" transform="rotate(45 12 12)"><path d="M12 17v5M9 3h6l1 7 2 2v2H6v-2l2-2 1-7z" /></svg>
            ) : (
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" transform="rotate(315 12 12)"><path d="M12 17v5M9 3h6l1 7 2 2v2H6v-2l2-2 1-7z" /></svg>
            )}
          </button>
          {pos && !pinned && (
