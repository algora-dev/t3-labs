...
export function ProposalPage({ proposal }: { proposal: ProposalConfig }) {
  ...
  const launchButtonLabel = copy.launchButtonLabel ?? "I'd like to launch this website";
  const includedItems = [
