...
**AI cannot replace user review.** Every AI-detected measurement must be verified by a human. This is not optional. If you skip review, you will eventually quote based on a wrong measurement. The [Stanford HAI AI Index Report](https://aiindex.stanford.edu/report/) tracks the state of AI capabilities and limitations across industries — and consistently finds that human oversight remains essential for high-stakes applications.
