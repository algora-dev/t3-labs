...
| Area | Can AI reduce effort? | Human still needed? |
|---|---|---|
| Routine coding | Often significantly | Review and validation |
| UI scaffolding | Often | Design and QA |
| Testing | Partly | Test strategy and review |
| Architecture | Limited | Yes |
| Business requirements | Limited | Yes |
| Integrations | Varies | Often |
| Security | Assistance only | Yes |
