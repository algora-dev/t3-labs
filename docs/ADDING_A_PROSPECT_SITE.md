...
3. Add images under `public/assets/example-roofing-wp-000206/`. Reference them as `/proposal-assets/example-roofing-wp-000206/<filename>` and supply meaningful alt text.
